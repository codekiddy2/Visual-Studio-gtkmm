...
./configure --with-gobject=yes --with-glib=yes CC=cl CXX=cl CPP='cl -nologo -EP' CXXCPP='cl -E' AR=lib LD=link CFLAGS='' CXXFLAGS='' CPPFLAGS='' LDFLAGS='' LIBS='' --enable-silent-rules --enable-shared --enable-static --x86_64-w64-mingw32 --x86_64-w64-mingw32 --prefix=$ROOT_DIR
make
