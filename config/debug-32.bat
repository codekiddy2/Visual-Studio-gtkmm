...
set ROOT_DIR=%REPO_DIR%\output\v140\Debug\Win32
set INCLUDE_DIR=%ROOT_DIR%\include
set COMPILER_DIR=%REPO_DIR%\configuration
...
set PATH=%INSTALL_DIR%\Python35\x86;%INSTALL_DIR%\Python35\x86\Scripts;%PATH%
set PATH=%INSTALL_DIR%\CMake\bin;%INSTALL_DIR%\nasm;%INSTALL_DIR%\BoostBuild\bin;%PATH%

REM Where is Perl installed?
set PATH=%INSTALL_DIR%\Perl\bin;%PATH%
REM set PATH=%INSTALL_DIR%\Perl64\bin;%PATH%

REM comment out CL to compile with default compiler options
set CL=@%COMPILER_DIR%\debug-32.compiler
...
call D:\Github\Install\msys64\mingw32_shell.bat
