...
./configure CC=cl CXX=cl CPP='cl -nologo -EP' CXXCPP='cl -E' AR=lib LD=link CFLAGS='' CXXFLAGS='' CPPFLAGS='' LDFLAGS='' LIBS='' --enable-silent-rules --enable-shared --enable-static --build=i686-pc-mingw32 --host=i686-pc-mingw32 --prefix=$ROOT_DIR
make
